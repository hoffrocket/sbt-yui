...
instead of <pre> val a = ... </pre>  do <pre> val sbtYui = "hoffrocket" %% "sbt-yui" %% "0.2"</pre>

and add _(piggybacking off of the maven yui compressor repo for yuicompressor-2.4.2.jar)_:

<pre>val sonaTypeReo = "Sonatype Repo" at "http://oss.sonatype.org/content/groups/github/"</pre>
